      ...
      <div className="container">
        <div className="flex items-center justify-between">
          ...
          <div onClick={() => setOpen(!open)} className="menu lg:block md:pr-6">
            <ul
              className={`md:flex md:items-center gap-9 md:pb-0 pb-12 absolute md:static bg-white left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in cursor-pointer ${
                open ? "top-[6rem]" : "top-[-490px]"
              }`}
            >
              <li
                onMouseOver={() => {
